...
## PHP - main constructions of language
...
22. Функции округления, генерации случайного числа, массива с диапозоном
```
ceil, floor - функции округляют в большую или меньшую сторону до целого

mt_rand(5, 15); // сгенерирует случайное число от 5 до 15

htmlspecialchars('<b>жирный текст</b>'); // функция  позволяет вывести теги в браузер как строки, а не команды.

range('a', 'e'); // создает массив с диапазоном элементов ['a', 'b', 'c', 'd', 'e'] 
